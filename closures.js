...
/*
  ...
  *Hint: setTimeout calls a function or evaluates an expression after a specified number of milliseconds.
    ...
    //Answer Here
    It will run 5 times.
    each time it will print the number of times it is on after a delay * the number it is on.
...
*/
  ...
  //funcArray is an array full of functions. Each function returns the number that is equivalent to the array index. ???
  (function arrayFill() {
    for (var i = 0; i < 6; i++) {
      (function(n) {
        funcArray.push(
